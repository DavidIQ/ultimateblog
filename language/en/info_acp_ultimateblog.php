...
$lang = array_merge($lang, array(
	...
	'ACP_UB_CATEGORY_DELETED_DELETE'		=> array(
		0	=> 'The Ultimate Blog category has successfully been deleted.<br /><br />There were %d stories that only belonged to this category. No stories have been deleted.',
		1	=> 'The Ultimate Blog category has successfully been deleted.<br /><br />There was %d story that only belonged to this category. This story has been deleted:<br />%s',
		2	=> 'The Ultimate Blog category has successfully been deleted.<br /><br />There were %d stories that only belonged to this category. These stories have been deleted:<br />%s',
	),
	'ACP_UB_CATEGORY_DELETE_MOVE'			=> array(
		0	=> 'The Ultimate Blog category has successfully been deleted.<br /><br />There were %d stories that did not already have the new category. No stories have been moved.',
		1	=> 'The Ultimate Blog category has successfully been deleted.<br /><br />There was %d story that did not already have the new category. The story has been added to the new category:<br />%s',
		2	=> 'The Ultimate Blog category has successfully been deleted.<br /><br />There were %d stories that did not already have the new category. The stories have been added to the new category:<br />%s',
	),
	...
	'ACP_UB_LOG_BLOG_EDIT_DELETED'		=> '<strong>Deleted an Ultimate Blog edit reason</strong><br>» Library: “%3$s” - Edit: %1$s: %2$s',
